...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'administrator' or user_member.status == 'creator':
        message.reply_text("ഈ ചെങ്ങായി അഡ്മിൻ തന്നെ ആണല്ലോ!")
        return ""

    if user_id == bot.id:
        message.reply_text("ചേട്ടാ...എനിക്ക് എന്നെ തന്നെ പ്രൊമോട്ട് ചെയ്യാൻ കഴിയൂല. വേറെ ആരേലും ചെയ്യേണ്ടി വരും😅.")
        return ""
    ...
    message.reply_text("ആഹ് മൂപ്പർ ഇപ്പൊ വലിയ നിലയിൽ എത്തിയിട്ടുണ്ട്! 👍🏻")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        message.reply_text("എനിക്ക് പറ്റുമെന്ന് തോന്നുന്നില്ല മച്ചാനെ!😔. ഒന്നെങ്കിൽ ഞാൻ അഡ്മിൻ ആയിരിക്കില്ല, അല്ലേൽ വേറെ ഏതേലും ചെങ്ങായി ആകും ആ മച്ചാനെ പ്രൊമോട്ട് ചെയ്തത് "
