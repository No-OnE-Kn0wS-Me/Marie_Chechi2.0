...
ഞൻ പൂർണ്ണമായും ഓപ്പൺ സോഴ്സ് ആണ് .        എന്നെ ഉണ്ടാക്കിയത് [ഈ](https://t.me/movielinks_only) ഗ്രൂപ്പ് മാനേജ് ചെയ്യാൻ വേണ്ടി ആണ്. [ഈ കോഡ്](https://heroku.com/deploy?template=https://github.com/salmanpdr/Marie_Chechi2.0)
...
എന്റെ ചേച്ചിയായ [മേരി](http://telegram.dog/BanhammerMarie_bot) ബോട്ട് ഉപയോഗിക്കുന്നത് എല്ലായ്പ്പോഴും എളുപ്പമായിരിക്കും. മേരി ചേച്ചിക്ക് English മാത്രമേ അറിയൂ..
...
*Main* ലഭ്യമായ commandകൾ:
 ...
 - /donate: നിങ്ങൾക്ക് ക്രീയേറ്റർക്ക് എന്തേലും പരിദോഷികം കൊടുക്കാൻ ആഗ്രഹം ഉണ്ടേൽ അതിനെ കുറിച്ച് അറിയാനുള്ള കമാൻഡ്!
 - /settings:
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 254318997 and DONATION_LINK:
            update.effective_message.reply_text("എന്നെ ഇപ്പോൾ നോക്കി നടത്തുന്ന ചെങ്ങായിക്കും നിങ്ങൾക്ക് donate ചെയ്യാവുന്നതാണ്"
        ...
        try:
            ...
            update.effective_message.reply_text("ഞാൻ നിങ്ങൾക്ക് എന്റെ creater ക്കു ഡോനേഷൻ ചെയ്യുന്നതിനെ കുറിച്ച് പേർസണൽ മെസ്സേജ് അയച്ചിട്ടുണ്ട് 😊!")
        except Unauthorized:
